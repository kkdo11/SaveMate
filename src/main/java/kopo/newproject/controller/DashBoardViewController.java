...
/**
 * 메인 대시보드 웹 페이지(View) 요청을 처리하는 컨트롤러.
 * <p>
 * {@code @Controller} - 이 클래스가 Spring MVC의 컨트롤러임을 나타냅니다. 뷰의 이름을 반환하여 렌더링합니다.
 * {@code @RequestMapping("/dashboard")} - 이 컨트롤러의 모든 메소드는 '/dashboard' 경로 하위에 매핑됩니다.
 */
@Slf4j
@Controller
...
public class DashBoardViewController {
    ...
    /**
     * 메인 대시보드 페이지를 사용자에게 보여줍니다.
     * <p>
     * 현재 사용자의 로그인 상태를 확인하여, 사용자 이름과 인증 여부를 모델에 담아 뷰로 전달합니다.
     *
     * @param model 컨트롤러에서 뷰로 데이터를 전달하기 위한 객체
     * @return 렌더링할 뷰의 논리적인 이름. "dashboard/dashBoard"는 'templates/dashboard/dashBoard.html' 파일을 가리킵니다.
     */
    @GetMapping("/page")
    public String getDashboardPage(Model model) {
        log.info("▶▶▶ [View] 대시보드 페이지 요청");
        ...
        log.info("◀◀◀ [View] 대시보드 페이지 반환: templates/dashboard/dashBoard.html");
